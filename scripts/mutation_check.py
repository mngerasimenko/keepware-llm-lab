...
MUTATIONS = [
    ...
    ("замер длины снова не проверяет ни статуса, ни результата", HOOK,
...
def main(argv=None):
    ...
    if os.path.isfile(BACKUP):
        print("Слепок %s остался на месте - разобрать его я не смог. Пока он "
              "лежит, мутации запускать нельзя: первая же его затрёт."
