...
Нарушение L1, L2 или L5 - выход с кодом 1. L3 и L4 печатаются предупреждениями,
...
def main(argv=None):
    ...
    if errors:
        ...
        print("Блокируют коммит L1 (битая ссылка из индекса), L2 (файл вне "
              "индекса) и L5 (имя в шапке не равно имени файла); "
              "L3 и L4 - предупреждения.")
        return EXIT_VIOLATION
    if warnings:
